...
| 防穿模扫掠守卫 | DEMO_IMPLEMENTED | 车身、双货叉和搬运载荷按 2.5D OBB 扫掠检查；三场景本地时间线禁碰数为 0，最小车身净距分别不低于 0.150441 m；这不等于完整动力学或生产安全认证 | `demo/seer_demo/isaac/collision.py`、`tests/test_timeline.py`；正式新录像待重渲染，旧 `20260813` 录像不作为此项证据 |
